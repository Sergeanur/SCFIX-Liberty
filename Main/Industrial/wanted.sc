...
//SWITCH_STREAMING OFF // SCFIX: useless, and shouldn't be messing with streaming when not under a fade
...
/* SCFIX: make loads non-blocking as there is no fade
LOAD_ALL_MODELS_NOW
...
// SCFIX: START - Also load the police car and the cop model, and wait for all models to load without blocking
...
//SWITCH_STREAMING ON // SCFIX: useless, and shouldn't be messing with streaming when not under a fade
...
RESTORE_CAMERA_JUMPCUT
//SWITCH_WIDESCREEN off // SCFIX: an earlier 'on' call was commented out already
SET_PLAYER_CONTROL player on
...
//SET_SWAT_REQUIRED FALSE // SCFIX: an earlier 'TRUE' call was commented out already
